...
### [​](#common-input-structure) Common Input Structure
...
### [​](#post_read_code) post\_read\_code
...
### [​](#pre_write_code) pre\_write\_code
...
### [​](#post_write_code) post\_write\_code
...
### [​](#pre_run_command) pre\_run\_command
...
### [​](#post_run_command) post\_run\_command
...
### [​](#pre_mcp_tool_use) pre\_mcp\_tool\_use
...
### [​](#post_mcp_tool_use) post\_mcp\_tool\_use
...
### [​](#pre_user_prompt) pre\_user\_prompt
...
### [​](#post_cascade_response) post\_cascade\_response
...
### [​](#post_setup_worktree) post\_setup\_worktree
...
### [​](#logging-all-cascade-actions) Logging All Cascade Actions
...
### [​](#blocking-policy-violating-prompts) Blocking Policy-Violating Prompts
...
### [​](#logging-cascade-responses) Logging Cascade Responses
...
### [​](#running-code-formatters-after-edits) Running Code Formatters After Edits
...
### [​](#verification-and-auditing) Verification and Auditing
...
### [​](#workspace-hooks-for-team-projects) Workspace Hooks for Team Projects
