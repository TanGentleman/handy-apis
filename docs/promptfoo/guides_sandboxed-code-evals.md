...
### Create the promptfoo configuration file[​](#create-the-promptfoo-configuration-file "Direct link to Create the promptfoo configuration file")
...
2. We're testing GPT-4o and Llama 3 (you can replace this with a [provider](/docs/providers/) of your choice. Promptfoo supports both local and commercial providers).
...
### Create the prompt template[​](#create-the-prompt-template "Direct link to Create the prompt template")
...
### Set up the Python assertion script[​](#set-up-the-python-assertion-script "Direct link to Set up the Python assertion script")
...
## Running the Evaluation[​](#running-the-evaluation "Direct link to Running the Evaluation")
...
## Analyzing Results[​](#analyzing-results "Direct link to Analyzing Results")
...
![llm evals with code generation](/assets/images/code-generation-webui-cfa0f6e7901c0ece100b18d795caac20.png)
...
[Edit this page](https://github.com/promptfoo/promptfoo/tree/main/site/docs/guides/sandboxed-code-evals.md)

Last updated on **Jan 30, 2026** by **Michael**

[Previous

Qwen vs Llama vs GPT](/docs/guides/qwen-benchmark/)[Next

Testing Guardrails](/docs/guides/testing-guardrails/)

* [Prerequisites](#prerequisites)
* [Configuration](#configuration)
  + [Create the promptfoo configuration file](#create-the-promptfoo-configuration-file)
  + [Create the prompt template](#create-the-prompt-template)
  + [Set up the Python assertion script](#set-up-the-python-assertion-script)
