...
def save_config(api_url):
    """Save API URL to config/settings.py.
    ...
    config_content = f'''"""Central configuration for docpull.

This file is auto-generated by setup.py after deployment.
Do not commit this file with real URLs - it will be regenerated on deploy.

Environment variable overrides:
- SCRAPER_API_URL: Override the API URL
- MODAL_KEY / MODAL_SECRET: Authentication credentials
"""

import os

# API URL - set by setup.py after Modal deployment
SCRAPER_API_URL: str | None = "{api_url}"

# Environment variable override (takes precedence over the above)
SCRAPER_API_URL = os.environ.get("SCRAPER_API_URL", SCRAPER_API_URL)

# Production mode flag - controls Modal proxy authentication
