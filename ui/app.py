...
try:
    from ui.config import SCRAPER_API_URL, IS_PROD
except ImportError:
    # Fallback for when running in Modal (config.py is in /root/)
    import sys
    sys.path.insert(0, "/root")
    try:
        from config import SCRAPER_API_URL, IS_PROD
    except ImportError:
        raise ImportError(
            "\n" + "=" * 70 + "\n"
...
image = (
    ...
    .add_local_file("ui/config.py", "/root/config.py")
)
